...
awful.spawn.with_shell(gears.filesystem.get_configuration_dir() .. "scripts/screens.sh")
...
globalkeys = gears.table.join(
    ...
    awful.key({ "Ctrl", "Shift"   }, "m", function () awful.spawn("mpv --player-operation-mode=pseudo-gui") end,
